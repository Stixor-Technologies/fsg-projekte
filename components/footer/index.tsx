      ...
      <div className="container pb-12 pt-[2.781rem] lg:pb-[4.563rem] 4xl:h-[33.625rem] 4xl:px-0">
        <div className="mx-auto max-w-[110.563rem]">
          ...
          {/* <div className="mt-[3.063rem] grid grid-cols-1 justify-between gap-8 sm:grid-cols-2 sm:gap-10 lg:grid-cols-[1fr,2fr,1fr] lg:gap-0 4xl:grid-cols-[21.063rem,306px,30.125rem,418px,14.125rem,] 4xl:justify-normal">
            ...
            <div className="row-start-3 sm:col-span-full sm:row-start-2 lg:col-span-1 lg:col-start-2 lg:row-start-1 lg:mt-[3.5rem] 4xl:col-start-3">
            ...
            <div className="sm:text-right 4xl:col-start-5 ">
              <h4 className="4xl-[1.438rem] font-proxima-semibold text-lg leading-[1.375rem] text-brown">
                UNTERNEHMEN
              </h4>
...
`}
          ...
          <div className="mt-[3.063rem] grid grid-cols-1 justify-between gap-8 sm:grid-cols-2 sm:gap-10 lg:grid-cols-[1fr,2fr,1fr] lg:gap-0 4xl:grid-cols-[21.063rem,306px,30.125rem,418px,14.125rem,] 4xl:justify-normal">
            ...
            <div className="row-start-1 sm:col-span-full sm:row-start-1 lg:col-span-1 lg:col-start-2 lg:row-start-1 lg:mt-[3.5rem] 4xl:col-start-3">
              ...
              <div className="mx-auto mt-2.5 flex flex-col justify-between sm:max-w-[20.875rem] sm:flex-row lg:mt-[2.563rem] 4xl:h-[1.125rem]">
                <Link
                  className=" font-proxima-semibold text-lg uppercase tracking-wide text-brown duration-300 hover:text-light-brown"
                  href={"/"}
                >
